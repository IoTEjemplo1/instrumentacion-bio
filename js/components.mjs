...
function initPowerSupplyActivity(onAwardXp) {
  ...
  function startPhase1Level(level) {
    ...
    // Asegurarnos de mantener el orden para que coincida visualmente (opcional), 
    // pero como el usuario no quiere números, los dejaremos con ícono misterioso o viñeta.
