...
export function renderHomeView(container, onNavigate) {
  container.innerHTML = `
    <div class="animate-fade-in d-flex flex-column gap-5">
      ...
      <section style="background: linear-gradient(135deg, var(--bg-sidebar) 0%, var(--color-primary) 100%); border-radius: var(--radius-lg); padding: 4rem 3rem; color: #fff; position: relative; overflow: hidden; border-bottom: 4px solid var(--color-secondary);">
        ...
        <div style="max-width: 700px; position: relative; z-index: 2;">
          <span style="font-size: 0.85rem; font-weight: bold; color: var(--color-secondary); text-transform: uppercase; letter-spacing: 0.15em;">
            Pontificia Universidad Javeriana • Ingenieria Biomédica
          </span>
          ...
          <p style="font-size: 1.25rem; color: rgba(255,255,255,0.85); margin: 1.5rem 0 2rem 0; line-height: 1.6;">
            Plataforma academica inmersiva para el diseno, simulacion y acondicionamiento de senales y variables fisiologicas en tecnologia medica y salud digital.
          </p>
          
          <div class="d-flex gap-3 flex-wrap">
            <button class="btn btn-secondary start-course-btn">Comenzar Curso ➔</button>
            <a href="#syllabus-overview" class="btn btn-outline text-white border-white-50 explore-methodology-btn">Explorar Metodologia</a>
          </div>
        </div>
      </section>
      ...
      <section class="row g-4">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card text-center py-4">
            <div style="font-size: 2.5rem; font-weight: 850; color: var(--color-secondary); font-family: var(--font-title);">13</div>
            <div class="small text-secondary fw-semibold">Clases Estructuradas</div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-3">
          <div class="card text-center py-4">
            <div style="font-size: 2.5rem; font-weight: 850; color: var(--color-secondary); font-family: var(--font-title);">11</div>
      ...
      <section id="syllabus-overview" class="row g-4">
        <div class="col-md-6">
          <div class="card h-100">
            ...
            <p class="small text-secondary mb-3">Al finalizar este curso, el estudiante de la Pontificia Universidad Javeriana estara en capacidad de:</p>
            <ul class="small text-secondary d-flex flex-column gap-2 ps-3">
              <li>Disenar sistemas analogicos discretos de amplificacion de biopotenciales de bajo ruido.</li>
              <li>Implementar filtros analogicos y digitales para remover artefactos de movimiento e interferencia electromagnetica.</li>
              <li>Caracterizar sensores y transductores de temperatura, presion, fuerza y gases en aplicaciones clinicas.</li>
              <li>Garantizar las normas internacionales de seguridad electrica en el diseno de equipos en contacto con pacientes.</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="card h-100">
            ...
            <ul class="small text-secondary d-flex flex-column gap-2 ps-3 mt-4">
              <li><strong>Analisis Espectral:</strong> Descomponer y comprender el espectro frecuencial de ECG, EMG y EEG para definir anchos de banda de filtrado.</li>
              <li><strong>Linealizacion:</strong> Linealizar sensores termicos y resistivos mediante puentes de Wheatstone de precision.</li>
              <li><strong>Firmware Medico:</strong> Desarrollar algoritmos de adquisicion analogica-digital estables en microcontroladores (Arduino, ESP32).</li>
              <li><strong>Fisiologia Cuantitativa:</strong> Relacionar las variables analogicas electricas con estados diagnosticos del paciente.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section class="row g-4 align-items-start">
        <div class="col-md-6">
          <div class="card h-100">
            <h3 class="h5 text-primary mb-4" style="font-family: var(--font-title);">📅 Metodologia y Cortes</h3>
            <div class="timeline-container">
              <div class="timeline-item">
                <div class="timeline-dot"></div>
                <h4 class="h6 text-primary fw-bold m-0">Corte I (30% de la Nota)</h4>
                <div class="small fw-semibold text-secondary my-1">Fundamentos y Filtrado Analogico</div>
                <p class="small text-secondary m-0">Desarrollo de laboratorios de senales, analisis espectral de Fourier y montaje fisico de filtros activos y pasivos.</p>
              </div>
              <div class="timeline-item">
                <div class="timeline-dot" style="background-color: var(--border-color);"></div>
                <h4 class="h6 text-primary fw-bold m-0">Corte II (30% de la Nota)</h4>
                <div class="small fw-semibold text-secondary my-1">Sensores e Instrumentacion Transductora</div>
                <p class="small text-secondary m-0">Medicion de temperatura con PT100 y puentes de Wheatstone, caracterizacion de celdas de carga y sensores de gases.</p>
              </div>
              <div class="timeline-item">
                <div class="timeline-dot" style="background-color: var(--border-color);"></div>
                <h4 class="h6 text-primary fw-bold m-0">Corte III (40% de la Nota)</h4>
                <div class="small fw-semibold text-secondary my-1">Instrumentacion Avanzada y Bioelectricidad</div>
                <p class="small text-secondary m-0">Diseno del front-end analogico para electrocardiografia (ECG), oximetros de pulso (SpO2) y proyecto final integrador.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="card h-100" style="border-top: 4px solid var(--color-secondary);">
            <h3 class="h5 text-primary mb-3" style="font-family: var(--font-title);">👨‍🏫 Profesor Coordinador</h3>
            <div class="d-flex gap-3 align-items-center mb-3">
              <div style="width: 60px; height: 60px; border-radius: 50%; background-color: var(--bg-sidebar); color: #fff; font-size: 1.8rem; display: flex; align-items: center; justify-content: center;">PA</div>
              <div>
                <div class="fw-bold text-dark-theme-adjust" style="font-size: 1.1rem; color: var(--text-primary);">${courseData.professor.name}</div>
                <div class="small text-secondary">${courseData.professor.title} • ${courseData.professor.department}</div>
              </div>
            </div>
            <p class="small text-secondary mb-3" style="line-height: 1.6;">${courseData.professor.bio}</p>
            <div class="small border-top pt-3">
              <strong>Lineas de Investigacion:</strong>
              <ul class="text-secondary ps-3 mt-1 m-0" style="font-size: 0.82rem;">
                ${courseData.professor.researchLines.map(line => `<li>${line}</li>`).join('')}
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="accordion" id="faqAccordion">
          <div class="accordion-item bg-transparent border-bottom border-top-0 border-start-0 border-end-0 border-color-adjust">
            <h2 class="accordion-header" id="headingOne">
              <button class="accordion-button bg-transparent collapsed text-primary fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                ¿Que herramientas de software necesito para el curso?
              </button>
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-secondary small">
                Utilizaremos MATLAB y Python para el procesamiento digital de senales biomedicas en laboratorios, y LTSpice/Multisim para simular circuitos analogicos antes del montaje.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item bg-transparent border-bottom border-top-0 border-start-0 border-end-0 border-color-adjust">
            <h2 class="accordion-header" id="headingTwo">
              <button class="accordion-button bg-transparent collapsed text-primary fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                ¿Cual es la metodologia de los laboratorios?
              </button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-secondary small">
                Cada tema teorico se complementa con un Laboratorio Virtual interactivo en esta plataforma para afianzar conceptos, y una guia de laboratorio fisico para armado de circuitos en hardware real.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item bg-transparent border-0">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-secondary small">
                La evaluacion comprende un 60% correspondiente a los informes y sustentaciones de practicas de laboratorio, y un 40% derivado de los examenes teoricos de cada corte.
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Bibliografia -->
      <section class="card">
        <h3 class="h5 text-primary mb-3" style="font-family: var(--font-title);">📚 Bibliografia Recomendada</h3>
        <ul class="small text-secondary d-flex flex-column gap-2 ps-3 m-0">
          <li><strong>Webster, J. G.</strong> (2009). <em>Medical Instrumentation: Application and Design</em>. John Wiley & Sons. (El estandar internacional en bioinstrumentacion).</li>
          <li><strong>Bronzino, J. D.</strong> (2006). <em>The Biomedical Engineering Handbook</em>. CRC Press.</li>
          <li><strong>Pallás-Areny, R., & Webster, J. G.</strong> (2001). <em>Sensors and Signal Conditioning</em>. Wiley-Interscience.</li>
        </ul>
      </section>
  ...
  container.querySelector('.explore-methodology-btn').addEventListener('click', (e) => {
    e.preventDefault();
    document.querySelector('#syllabus-overview').scrollIntoView({ behavior: 'smooth' });
  });
}
  ...
  container.innerHTML = `
    <div class="animate-fade-in d-flex flex-column gap-4">
      ...
      <div class="nav-tabs-custom">
        ...
        <button class="nav-link-custom" data-tab="quiz">静态 Autoevaluacion</button>
      </div>
      ...
      <div class="border-top pt-4 mt-3 d-flex justify-content-between gap-3">
        ...
        ${nextTopic ? `
          <button class="btn btn-primary text-end d-flex flex-column align-items-end next-topic-btn" style="padding: 0.6rem 1.2rem;">
            <span class="small text-light" style="opacity: 0.8;">Siguiente Tema ▶</span>
        ...
        ` : `
          <button class="btn btn-secondary text-end d-flex flex-column align-items-end finish-route-btn" style="padding: 0.6rem 1.2rem;">
            <span class="small text-light" style="opacity: 0.8;">Finalizar Ruta ▶</span>
...
void loop() {
  ...
  delay(500);
    ...
    'clase-10': `// @file Ultrasonido.ino
// @description Medicion de distancia por tiempo de vuelo
const int Trigger = 4;
const int Echo = 5;
...
void loop() {
  ...
  delayMicroseconds(10); // Pulso de trigger de 10us
  digitalWrite(Trigger, LOW);
  
  t = pulseIn(Echo, HIGH); // Medicion de ancho de pulso
  d = t / 59; // conversion a cm (t * 0.034 / 2)
  ...
  delay(300);
    ...
    'clase-11': `// @file FrecuenciaC.ino
// @description Filtro y calculo preliminar de pulsos cardiacos
const int ppgPin = A0;
const int threshold = 550; // Ajustable segun offset DC del fotodiodo
...
void loop() {
  int val = analogRead(ppgPin);
  unsigned long now = millis();
  
  if (val > threshold && (now - lastBeatTime) > 300) { // Antirrebote de 300ms
    beatCounter++;
    unsigned long interval = now - lastBeatTime;
    float bpm = 60000.0 / interval;
    
    Serial.print("❤️ LATIDO DETECTADO. BPM Estimados: ");
    Serial.println(bpm);
    lastBeatTime = now;
  }
  
  // Imprimir valor analogico para Serial Plotter
  Serial.println(val);
  delay(10);
}`
  };
  ...
  const switchTab = (tabId) => {
    ...
    if (tabId === 'theory') {
      tabContent.innerHTML = `
        <div class="animate-fade-in d-flex flex-column gap-3 small-text-adjust" style="line-height: 1.75; font-size: 1.02rem; color: var(--text-secondary);">
          <div class="p-3 bg-light rounded-3 border-start border-4 border-secondary small" style="font-style: italic; background-color: var(--bg-tertiary) !important;">
            <strong>Resumen Ejecutivo:</strong> ${currentTopic.summary}
          </div>
          <div>
      ...
      const renderSlidesFrame = () => {
        ...
        const hasUrl = activeUrl && (activeUrl.startsWith('http://') || activeUrl.startsWith('https://'));
          ...
          <div class="animate-fade-in d-flex flex-column gap-3">
            ...
            ${hasUrl ? `
              <div style="width: 100%; height: 480px; border-radius: var(--radius-md); overflow: hidden; border: 1px solid var(--border-color); box-shadow: var(--shadow-md); background-color: #000;">
                <iframe src="${activeUrl}" frameborder="0" width="100%" height="100%" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" title="Presentacion"></iframe>
              </div>
            ` : `
              <div class="d-flex flex-column align-items-center justify-content-center text-center text-white" style="width: 100%; height: 450px; background-color: #0a192f; border-radius: var(--radius-md); border: 1px solid var(--border-color); padding: 2rem;">
                ...
                <p class="small text-secondary" style="max-width: 400px;">
                  [Diapositivas correspondientes a la catedra de Bioinstrumentacion. Descargalas en la pestana de Descargas]
                </p>
              </div>
            `}
          </div>
              ...
              return `
                <div class="card p-3 d-flex flex-row justify-content-between align-items-center flex-wrap gap-2">
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                      <div class="fw-bold small text-dark-theme-adjust">${res.name}</div>
              ...
              return `
                <div class="card p-3 d-flex flex-row justify-content-between align-items-center flex-wrap gap-2">
                  <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                      <div class="fw-bold small text-dark-theme-adjust">${lab.title}</div>
        ...
        codeHTML = `
          <div class="d-flex flex-column gap-2 mt-3">
            <div class="d-flex justify-content-between align-items-center">
              <span class="small text-secondary fw-bold" style="font-size: 0.75rem; letter-spacing: 0.05em;">CODIGO DE FIRMWARE SUGERIDO</span>
          ...
          return `
            <div class="d-flex flex-column gap-2 mt-4 pt-3 border-top">
              ...
              <div style="width: 100%; height: 800px; border-radius: var(--radius-md); overflow: hidden; border: 1px solid var(--border-color); background-color: var(--bg-secondary);">
                <iframe src="./public/${simFile}" width="100%" height="100%" style="border:none;" loading="lazy"></iframe>
              </div>
            </div>
          `;
        }).join('');
      ...
      tabContent.innerHTML = `
        <div class="animate-fade-in d-flex flex-column gap-3">
          ...
          <h3 class="h6 text-primary fw-bold m-0">Hardware y Codigo Firmware</h3>
          <p class="small text-secondary m-0">Consulte el codigo de programacion y guias practicas. Utilice Tinkercad para simulaciones virtuales si no dispone del hardware fisico.</p>

          <!-- Tinkercad Promo Card -->
          <div class="card p-3 bg-light border flex-row gap-3 align-items-center flex-wrap" style="background-color: var(--bg-tertiary) !important;">
            <div style="flex: 0 0 140px; height: 90px; border-radius: var(--radius-sm); overflow: hidden; border: 1px solid var(--border-color);">
              <img src="./public/tinkercad_preview.png" alt="Tinkercad preview" style="width:100%; height:100%; object-fit:cover;">
            </div>
            <div class="flex-grow-1" style="min-width: 240px;">
              <h4 class="h6 m-0 fw-bold text-dark-theme-adjust">Simulacion en Tinkercad Circuits</h4>
              <p class="m-0 text-secondary" style="font-size: 0.8rem; line-height: 1.4;">Disene, conecte y simule microcontroladores Arduino y circuitos electronicos completos en la nube.</p>
              <a href="https://www.tinkercad.com/" target="_blank" class="btn btn-sm btn-secondary px-3 mt-2" style="font-size: 0.78rem;">🚀 Abrir Tinkercad</a>
            </div>
          </div>
      ...
      <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-3 col-md-4 d-flex flex-column gap-2">
          ...
          <button class="btn btn-outline text-start d-flex flex-column w-100 lab-tab-btn active" data-lab-id="ecg">
            ...
            <span class="fw-bold small text-dark-theme-adjust">🫀 Filtrado de ECG</span>
          </button>
          
          <button class="btn btn-outline text-start d-flex flex-column w-100 lab-tab-btn" data-lab-id="emg">
            <span class="badge badge-gold p-0 mb-1" style="font-size:0.65rem; background:none;">Biopotenciales</span>
            <span class="fw-bold small text-dark-theme-adjust">💪 Envolvente de EMG</span>
          </button>

          <button class="btn btn-outline text-start d-flex flex-column w-100 lab-tab-btn" data-lab-id="eeg">
            <span class="badge badge-gold p-0 mb-1" style="font-size:0.65rem; background:none;">Biopotenciales</span>
            <span class="fw-bold small text-dark-theme-adjust">🧠 Ondas Cerebrales EEG</span>
          </button>
          ...
          <button class="btn btn-outline text-start d-flex flex-column w-100 lab-tab-btn" data-lab-id="spo2">
            ...
            <span class="fw-bold small text-dark-theme-adjust">🩸 Pulsioximetria SpO2</span>
          </button>
        </div>
        ...
        <div class="row g-3">
          <div class="col-lg-4 col-sm-6">
            <div class="card p-3 h-100" style="opacity: 0.85;">
              ...
              <h4 class="h6 fw-bold text-dark-theme-adjust">🌡️ Puente de Wheatstone (PT100)</h4>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="card p-3 h-100" style="opacity: 0.85;">
              ...
              <h4 class="h6 fw-bold text-dark-theme-adjust">🔊 Pulso Arterial Piezoelectrico</h4>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="card p-3 h-100" style="opacity: 0.85;">
              ...
              <h4 class="h6 fw-bold text-dark-theme-adjust">🌬️ Capnografia NDIR</h4>
        ...
        <div class="col-lg-4 col-md-5 d-flex flex-column gap-3">
          <div class="card">
            ...
            <div class="border-top pt-3 text-secondary" style="font-size:0.8rem;">
              <div class="fw-bold mb-1 text-dark-theme-adjust">Ficha Tecnica:</div>
            ...
            return `
              <div class="col-md-3 col-sm-6">
                <div class="card text-center p-3 h-100 d-flex flex-column align-items-center gap-2" style="border-color: ${isUnlocked ? 'var(--color-secondary)' : 'var(--border-color)'}; background-color: ${isUnlocked ? 'var(--bg-secondary)' : 'rgba(0,0,0,0.015)'}; opacity: ${isUnlocked ? '1' : '0.75'};">
                  ...
                  <h4 class="h6 fw-bold text-dark-theme-adjust m-0">${b.title}</h4>
...
function initGeneratorActivity(onAwardXp) {
  ...
  const componentsList = [
    {
      id: "pantalla-lcd",
      name: "Pantalla LCD",
      description: "Pantalla a color de 3.5 pulgadas. Muestra los parámetros de amplitud, frecuencia, offset, fase y la forma de onda activa para los dos canales del generador.",
      bioApp: "Crucial para previsualizar la morfología de la señal simulada (ej. el impulso cardíaco de un ECG) antes de inyectarlo en el hardware amplificador.",
      coords: { top: 26.5, left: 17.5, width: 26, height: 35.5 },
      hint: "Es la gran pantalla rectangular de visualización al lado izquierdo del panel."
    },
    {
      id: "botones-softkey",
      name: "Botones Softkey",
      description: "Teclas laterales dinámicas cuya función cambia según el menú seleccionado en la pantalla (ej. selección de unidades, tipo de modulación).",
      bioApp: "Se usan para cambiar las escalas físicas de la señal a inyectar, por ejemplo reduciendo de voltios (V) a milivoltios (mV) para emular bioseñales.",
      coords: { top: 32, left: 44.5, width: 3.5, height: 28 },
      hint: "Es la columna vertical de 5 botones blancos ubicada al lado derecho de la pantalla."
    },
    {
      id: "encendido",
      name: "Encendido",
      description: "Botón físico tipo interruptor que energiza o apaga por completo el circuito interno del instrumento.",
      bioApp: "Siempre se debe apagar el equipo antes de modificar las conexiones en la protoboard para prevenir transitorios que puedan dañar sensores o amplificadores.",
      coords: { top: 64, left: 16, width: 4.5, height: 8 },
      hint: "Es el pulsador de color verde situado en la esquina inferior izquierda."
    },
    {
      id: "teclas-forma-onda",
      name: "Teclas de Forma de Onda",
      description: "Botones de acceso directo para las formas de onda estándar: senoidal (Sine), cuadrada (Square), rampa (Ramp), pulso (Pulse), arbitraria (Arb) y ruido (Noise).",
      bioApp: "La senoidal evalúa la respuesta en frecuencia de filtros analógicos, mientras que el ruido (Noise) simula la interferencia electromagnética de 60Hz hospitalaria.",
      coords: { top: 64, left: 21.5, width: 22, height: 7 },
      hint: "Es la fila horizontal de botones con pequeños esquemas de ondas bajo la pantalla."
    },
    {
      id: "teclado-numerico",
      name: "Teclado Numérico",
      description: "Bloque de botones numéricos (0-9, punto y cambio de signo) que permite ingresar valores numéricos precisos.",
      bioApp: "Permite establecer frecuencias específicas para simulaciones biológicas rápidas (ej. 1.2 Hz equivalentes a 72 pulsaciones por minuto cardíacas).",
      coords: { top: 26.5, left: 49, width: 12, height: 21.5 },
      hint: "Es el bloque de 12 botones negros con números ubicado en la parte central."
    },
    {
      id: "perilla-multifuncion",
      name: "Perilla Multifunción",
      description: "Dial giratorio infinito que permite incrementar, decrementar o sintonizar de manera fina el parámetro digital activo en la pantalla.",
      bioApp: "Útil para barridos de frecuencia manuales al buscar la frecuencia de resonancia o de corte exacta de un filtro analógico en la protoboard.",
      coords: { top: 26.5, left: 62.5, width: 7, height: 13.5 },
      hint: "Es la perilla giratoria blanca y redonda en la parte superior derecha."
    },
    {
      id: "teclas-navegacion",
      name: "Teclas de Navegación",
      description: "Flechas izquierda y derecha junto a la tecla BKSP (borrar) para desplazar el dígito seleccionado y editar valores.",
      bioApp: "Permiten seleccionar qué cifra decimal alterar en filtros biomédicos de banda estrecha (ej. sintonización de filtros Notch de 60 Hz).",
      coords: { top: 41.5, left: 62, width: 7.5, height: 7.5 },
      hint: "Son las dos flechas y el botón de borrar abajo del dial multifunción."
    },
    {
      id: "botones-utility",
      name: "Botones Utility",
      description: "Teclas dedicadas para ingresar al menú de sistema (Utility), ayuda interactiva (Help) e intercambio de canales (Inter CH).",
      bioApp: "En Utility se debe configurar la impedancia de salida del canal en High Z, para que las tensiones inyectadas en la protoboard coincidan con las de la pantalla.",
      coords: { top: 26.5, left: 70, width: 5.5, height: 21.5 },
      hint: "Son los tres botones blancos apilados verticalmente en el borde derecho superior."
    },
    {
      id: "seleccion-canal",
      name: "Selección de Canal",
      description: "Pulsadores para seleccionar los menús dinámicos de los canales 1 y 2 (Ch1/2), copiar parámetros (Both) o habilitar modulación (Mod).",
      bioApp: "Both copia la configuración a ambos canales, permitiendo inyectar señales complementarias diferenciales en amplificadores diferenciales de biopotenciales.",
      coords: { top: 49.5, left: 50, width: 5.5, height: 18 },
      hint: "Es el trío de botones blancos (Ch1/2, Both, Mod) abajo del teclado de números."
    },
    {
      id: "salidas-bnc",
      name: "Salidas BNC",
      description: "Bornes metálicos coaxiales BNC para los Canales 1 y 2, provistos de botones iluminados On/Off independientes.",
      bioApp: "Conectores directos desde el generador a la etapa de entrada analógica de tus circuitos de ECG/EMG mediante cables coaxiales BNC a caimán.",
      coords: { top: 50.5, left: 58, width: 14, height: 17.5 },
      hint: "Son las dos tomas cilíndricas de metal con botones On/Off en la esquina inferior derecha."
    },
    {
      id: "puerto-usb",
      name: "Puerto USB",
      description: "Puerto frontal para memorias flash USB que permite cargar formas de onda arbitrarias personalizadas en formatos CSV u hojas de datos.",
      bioApp: "Permite importar una señal biológica grabada directamente de una base de datos real (ej. PhysioNet) y reproducirla eléctricamente.",
      coords: { top: 61.5, left: 45, width: 3, height: 8.5 },
      hint: "Es el pequeño conector USB vertical situado abajo de la columna de softkeys."
    }
  ];
  ...
  const triviaQuestions = [
    ...
    },
    {
      ...
      options: [
        ...
        "Para evitar atenuaciones, ya que los amplificadores médicos tienen alta impedancia de entrada y esperan una lectura sin el divisor resistivo de 50 Ω.",
  ...
  const startPhase1 = () => {
    ...
    // Rellenar banco de tarjetas mezcladas
    const shuffledComponents = [...componentsList].sort(() => Math.random() - 0.5);
    cardsBank.innerHTML = '';
    ...
    componentsList.forEach(comp => {
      ...
      hotspot.addEventListener('dragover', (e) => {
        e.preventDefault();
        hotspot.classList.add('drag-hover');
      });
      hotspot.addEventListener('dragleave', () => {
        hotspot.classList.remove('drag-hover');
      });
      ...
      hotspot.addEventListener('click', () => {
        if (selectedDraggableId) {
          ...
          // Si no hay tarjeta seleccionada, mostrar hint temporal de este componente
...
function initPowerSupplyActivity(onAwardXp) {
  ...
  function startPhase1Level(level) {
    ...
    compsInLevel.forEach(comp => {
      ...
      hotspot.addEventListener('dragover', e => { e.preventDefault(); hotspot.classList.add('drag-hover'); });
      hotspot.addEventListener('dragleave', e => { hotspot.classList.remove('drag-hover'); });
      hotspot.addEventListener('drop', e => {
        e.preventDefault();
        hotspot.classList.remove('drag-hover');
