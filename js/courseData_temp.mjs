            ...
            <div class="row g-4 mb-4">
              ...
              <div class="col-12 col-lg-6">
                <div class="card h-100 p-3 bg-dark-card border border-indigo">
                  <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <h4 class="h6 m-0 fw-bold text-primary">Generador de Funciones (Tektronix AFG1022)</h4>
                  </div>
                  ...
                  <div class="mb-3 text-center" style="border-radius: var(--radius-sm); overflow: hidden; border: 1px solid var(--border-color); background-color: #0b132b;">
                    <img src="./public/generador_funciones.png" alt="Generador de Funciones Tektronix AFG1022" class="img-fluid" style="max-height: 200px; object-fit: contain; padding: 5px;">
                  </div>
              ...
              <div class="col-12 col-lg-6">
                <div class="card h-100 p-3 bg-dark-card border">
                  <div class="d-flex align-items-center gap-2 mb-2">
                    <span class="fs-4">🔋</span>
                    <h4 class="h6 m-0 fw-bold text-primary">Fuente de Alimentación</h4>
                  </div>
                  <p class="small text-secondary mb-3">
                    Suministra energía eléctrica de corriente continua (DC) regulada y estable para alimentar los componentes activos del circuito (como amplificadores operacionales y microcontroladores).
                  </p>
                  <div class="mb-3 text-center" style="border-radius: var(--radius-sm); overflow: hidden; border: 1px solid var(--border-color); background-color: #0b132b;">
                    <img src="./public/fuente_poder.jpg" alt="Fuente de Alimentación DC" class="img-fluid" style="max-height: 200px; object-fit: contain; padding: 5px;">
                  </div>
                  <ul class="small text-secondary ps-3 mb-0">
                    <li><strong>Alimentación Simétrica (Dual):</strong> Los amplificadores de instrumentación y operacionales suelen requerir fuentes simétricas (por ejemplo, <code>+15V</code>, <code>-15V</code> y una referencia común <code>GND</code>) para permitir la excursión de voltaje en valores tanto positivos como negativos sin saturación.</li>
                    <li><strong>Limitación de Corriente:</strong> Permite configurar una corriente máxima de seguridad. Si el circuito tiene un cortocircuito, la fuente bajará el voltaje para limitar la corriente y proteger los componentes.</li>
                  </ul>
                  <div class="mt-4 text-center">
                    <button id="btn-activate-ps-activity" class="btn btn-sm fw-bold px-3 py-2 shadow-sm w-100" style="background-color: #10b981; color: #fff; border: none; border-radius: var(--radius-sm); transition: transform 0.2s;">
                      🔌 Simulador: Fuente de Alimentación
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12 col-lg-6">
                <div class="card h-100 p-3 bg-dark-card border">
                  <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <h4 class="h6 m-0 fw-bold text-primary">Multímetro Digital (DMM)</h4>
                  </div>
                  <p class="small text-secondary mb-3">
                    Instrumento multipropósito para verificar y diagnosticar el estado eléctrico de un circuito mediante la medición de variables estáticas y continuas.
                  </p>
                  <ul class="small text-secondary ps-3 mb-0">
                    <li><strong>Medición de Voltaje (V) y Corriente (A):</strong> Configurable en modo DC o AC. Se conecta en paralelo para voltaje y en serie para corriente.</li>
                    <li><strong>Medición de Resistencia (Ω):</strong> Permite verificar los valores de los resistores de precisión antes de soldar o montar en la protoboard. <em>Nota: Nunca medir resistencia con el circuito energizado.</em></li>
                    <li><strong>Prueba de Continuidad (🔊):</strong> Emite un pitido audible cuando la resistencia entre las puntas es muy baja. Es la herramienta principal para encontrar cortocircuitos involuntarios o pistas cortadas.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="card p-4 border border-success mb-4 bg-dark-card shadow d-none" id="power-supply-interactive-activity-root">
              ...
              <div class="row g-4 position-relative">
                ...
                <div class="col-12 col-lg-4 d-flex flex-column gap-3" id="ps-left-control-panel">
                  ...
                  <div class="fase-container d-flex flex-column gap-2" id="ps-phase-1-cards-container">
                    <div class="alert alert-info py-2 px-3 small border-0 mb-2" style="background-color: rgba(16, 185, 129, 0.1); color: var(--text-primary); font-size: 0.8rem;">
                      💡 <strong>¿Cómo jugar?</strong> Arrastra las tarjetas hacia los marcadores circulares de la fuente.
                    </div>
                    <div class="d-flex flex-column gap-2" id="ps-draggable-cards-bank" style="min-height: 200px; padding: 5px; border-radius: var(--radius-sm); border: 1px dashed var(--border-color); background-color: rgba(0,0,0,0.15);">
                ...
                <div class="col-12 col-lg-8">
                  <div class="position-relative w-100 rounded overflow-hidden shadow-lg" id="ps-image-hotspots-wrapper" style="background-color: #0b0f19; border: 1px solid var(--border-color); min-height: 200px;">
                    <img src="./public/fuente_poder.jpg" alt="Fuente PeakTech 6145" class="img-fluid w-100" style="display: block; pointer-events: none; user-select: none; max-width: 100%; height: auto;">
            ...
            <div class="card p-4 border border-indigo mb-4 bg-dark-card shadow d-none" id="afg1022-interactive-activity-root">
              ...
              <div class="row g-4 position-relative">
                ...
                <div class="col-12 col-lg-4 d-flex flex-column gap-3" id="left-control-panel">
                  ...
                  <div class="fase-container d-flex flex-column gap-2" id="phase-1-cards-container">
                    <div class="alert alert-info py-2 px-3 small border-0 mb-2" style="background-color: rgba(99, 102, 241, 0.1); color: var(--text-primary); font-size: 0.8rem;">
                      💡 <strong>¿Cómo jugar?</strong> Arrastra las tarjetas hacia los marcadores circulares del generador, o haz clic en una tarjeta y luego en un marcador para emparejarlos.
                    </div>
                    <div class="d-flex flex-column gap-2" id="draggable-cards-bank" style="min-height: 200px; padding: 5px; border-radius: var(--radius-sm); border: 1px dashed var(--border-color); background-color: rgba(0,0,0,0.15);">
                      <!-- Se inyectará dinámicamente -->
                    </div>
                  </div>
                ...
                <div class="col-12 col-lg-8">
                  <div class="position-relative w-100 rounded overflow-hidden shadow-lg" id="image-hotspots-wrapper" style="background-color: #0b0f19; border: 1px solid var(--border-color); min-height: 200px;">
                    ...
                    <img src="./public/generador_funciones.png" alt="Generador Tektronix AFG1022" class="img-fluid w-100" style="display: block; pointer-events: none; user-select: none; max-width: 100%; height: auto;">
                    ...
                    <div class="d-none" id="lcd-virtual-screen" style="position: absolute; top: 25.5%; left: 17.1%; width: 26.5%; height: 37.5%; background-color: #020b12; color: #64ffda; font-family: monospace; padding: 8px; box-sizing: border-box; overflow: hidden; border: 1px solid #10b981; box-shadow: inset 0 0 10px rgba(16,185,129,0.3); z-index: 10; font-size: 0.72rem; border-radius: 2px;">
